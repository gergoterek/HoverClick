...
- The v0.8.0 Phase 1 updater implementation branch adds Sparkle 2 manual update support without changing version/build metadata.
...
- The appcast is planned future release infrastructure and may not be live yet in Phase 1.
